(() => {
    ...
    const levelInfo = [
        ...
        {level: 5, step: 50, grid: 3},
        {level: 6, step: 50, grid: 4},
        {level: 7, step: 45, grid: 4},
        {level: 8, step: 45, grid: 4},
        {level: 9, step: 40, grid: 4},
        {level: 10, step: 40, grid: 4},
        {level: 11, step: 38, grid: 5},
        {level: 12, step: 38, grid: 5},
        {level: 13, step: 38, grid: 5},
        {level: 14, step: 35, grid: 5},
        {level: 15, step: 35, grid: 5},
        {level: 16, step: 32, grid: 6},
        {level: 17, step: 32, grid: 6},
        {level: 18, step: 30, grid: 6},
        {level: 19, step: 30, grid: 6},
        {level: 20, step: 30, grid: 6},
        {level: 21, step: 28, grid: 7},
        {level: 22, step: 28, grid: 7},
